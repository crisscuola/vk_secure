...
public class FragmentDialogsList extends ListFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(extras.getBoolean("from_splash")) {
            ArrayList<VKApiMessage> messages = extras.getParcelableArrayList("messages");
            ArrayList<String> users = extras.getStringArrayList("users");
            ArrayList<VKApiUser> photo = extras.getParcelableArrayList("photo");
            Log.d("test", String.valueOf(users.size()) + " " + messages.size() + "  " + photo.isEmpty());
            VKList<VKApiUser> photos = new VKList<VKApiUser>(photo);
            setListAdapter(new DialogsListAdapter(inflater.getContext(), users, messages, photos));
            extras.clear();
        } else {
